...
# file: icpc.tcl
# 
## Marking and classification policies for contests used as exams
...
proc exam::subjective {} {
    return 1
}

## Sort teams by rank
proc exam::order {teams problems subs} {
    variable probs
    variable attpt   
    variable marks
    ...
    return [ lsort -command ::exam::cmp_pont $teams ]
}

## Assign ranks to teams
proc exam::rank {contest list} {
    variable probs 
